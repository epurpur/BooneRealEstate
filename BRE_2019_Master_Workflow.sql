...
SELECT res.* 
INTO Zone1aKeepers
FROM public."Zone1a" AS z1a, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone1bKeepers
FROM public."Zone1b" AS z1b, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone1cKeepers
FROM public."Zone1c" AS z1c, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone1dKeepers
FROM public."Zone1d" AS z1d, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone1eKeepers
FROM public."Zone1e" AS z1e, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone1fKeepers
FROM public."Zone1f" AS z1f, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone1gKeepers
FROM public."Zone1g" AS z1g, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone1hKeepers
FROM public."Zone1h" AS z1h, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone1iKeepers
FROM public."Zone1i" AS z1i, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone1jKeepers
FROM public."Zone1j" AS z1j, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2aKeepers
FROM public."Zone2a" AS z2a, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2bKeepers
FROM public."Zone2b" AS z2b, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2cKeepers
FROM public."Zone2c" AS z2c, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2dKeepers
FROM public."Zone2d" AS z2d, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2eKeepers
FROM public."Zone2e" AS z2e, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2fKeepers
FROM public."Zone2f" AS z2f, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2gKeepers
FROM public."Zone2g" AS z2g, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2hKeepers
FROM public."Zone2h" AS z2h, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2iKeepers
FROM public."Zone2i" AS z2i, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone2jKeepers
FROM public."Zone2j" AS z2j, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone3aKeepers
FROM public."Zone3a" AS z3a, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone3bKeepers
FROM public."Zone3b" AS z3b, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone3cKeepers
FROM public."Zone3c" AS z3c, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone3dKeepers
FROM public."Zone3d" AS z3d, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone3eKeepers
FROM public."Zone3e" AS z3e, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone3fKeepers
FROM public."Zone3f" AS z3f, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone3gKeepers
FROM public."Zone3g" AS z3g, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone4aKeepers
FROM public."Zone4a" AS z4a, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone4bKeepers
FROM public."Zone4b" AS z4b, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone4cKeepers
FROM public."Zone4c" AS z4c, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone4dKeepers
FROM public."Zone4d" AS z4d, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone4eKeepers
FROM public."Zone4e" AS z4e, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone4fKeepers
FROM public."Zone4f" AS z4f, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone4gKeepers
FROM public."Zone4g" AS z4g, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone4hKeepers
FROM public."Zone4h" AS z4h, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5aKeepers
FROM public."Zone5a" AS z5a, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5bKeepers
FROM public."Zone5b" AS z5b, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5cKeepers
FROM public."Zone5c" AS z5c, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5dKeepers
FROM public."Zone5d" AS z5d, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5eKeepers
FROM public."Zone5e" AS z5e, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5fKeepers
FROM public."Zone5f" AS z5f, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5gKeepers
FROM public."Zone5g" AS z5g, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5hKeepers
FROM public."Zone5h" AS z5h, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5iKeepers
FROM public."Zone5i" AS z5i, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5jKeepers
FROM public."Zone5j" AS z5j, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5kKeepers
FROM public."Zone5k" AS z5k, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5lKeepers
FROM public."Zone5l" AS z5l, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5mKeepers
FROM public."Zone5m" AS z5m, public."all_2019_parcels" AS res
...
SELECT res.* 
INTO Zone5nKeepers
FROM public."Zone5n" AS z5n, public."all_2019_parcels" AS res
