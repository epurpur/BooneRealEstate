...
#see state of 2+ removed column in Matt's 4/20 list
print('Before Merge')
print(matt_parcel_update_excel['2+ Removed'].value_counts())

"""
Results:
X - Owns Multiple              7193
X - Government                 1822
X - Realtor                    1536
X - Developer                   874
X - Developer Box               652
X - State                       597
X - Twice Returned              315
X - Life Estate                 112
X - Business                    105
X - Cemetery                     69
X - Mad Child                    51
X - Attorney                     38
X - Development                  24
X - Unknown Address              19
X - Bad Address                  17
X - Vendor                        7
X - Unknown Mailing Address       7
X - Mad Children                  4
X - Personal List                 1
X - International Address         1
X - Annuity                       1
X - Town                          1
                                  1
"""
...
print('After Merge')
print(all_2019_parcels['2+ Removed'].value_counts())
"""
#There SHOULD be more results, because all_2019_parcels has duplicate parcels (parno)

Results:
X - Owns Multiple              7426
X - Government                 1859
X - Realtor                    1546
X - Developer                   904
X - Developer Box               679
X - State                       601
X - Twice Returned              316
X - Life Estate                 118
X - Business                    115
X - Cemetery                     69
X - Mad Child                    52
...
columns_to_drop = ['id_0','id','Unnamed: 0','altparno_x','cntyfips_x','cntyname_x','gisacres_x','gnisid','improvval_x','landval_x','legdecfull','maddpref',
                   'maddrno','maddstname','maddstr','maddstsuf','maddsttyp','mailadd_x','mapref','mcity_x','mstate_x','multistruc_x','munit','mzip_x',
                   'nparno','ownfrst','ownlast','ownname_x','ownname2_x','owntype','parusecd2_x','parusecode_x','parusedesc_x','parusedsc2',
                   ...
                   'subdivisio','subowntype','subsurfown','sunit','szip','transfdate_x','layer','path','geometry_y','alt alt parno (from CRS)','Successful Merge']
