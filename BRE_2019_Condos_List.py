...
#add Vacant Land type
final_mailing_2019.loc[(final_mailing_2019['VacantLand'] == 'Yes'), 'Property Type'] = 'Vacant Land'

final_mailing_2019 = final_mailing_2019.merge(condos_df, how='left', left_on='parno', right_on='Parcel ID')

#Add condos type
final_mailing_2019.loc[([final_mailing_2019['Parcel ID'].notnull()]), 'Property Type'] = 'Condo'
...
####try to pick up with this code in 2020???
...
#global_df = global_df.merge(condos_df, how='left', left_on='parno', right_on='Parcel ID')  #629 matches
#global_df.loc[(global_df['Parcel ID'] != None), 'Added Condo'] = 'Yes'
#
#
...
##results4 = condos_df[condos_df['Parcel ID 15'].isin(global_df['Parcel ID 15'])]    #1660 matches
#
...
#global_df.columns = ['id_0','id','altparno','cntyfips','cntyname','gisacres','gnisid','improvval','landval','legdecfull','maddpref',
# 'maddrno','maddstname','maddstr','maddstsuf','maddsttyp','mailadd','mapref','mcity','mstate','multistruc','munit','mzip','nparno','ownfrst',
# 'ownlast','ownname','ownname2','owntype','parno','parusecd2','parusecode','parusedesc','parusedsc2','parval','parvaltype','presentval',
# 'recareano','recareatx','revdatetx','revisedate','reviseyear','saddno','saddpref','saddstname','saddstr','saddstsuf','saddsttyp',
# 'saledate','saledatetx','scity','siteadd','sourceagnt','sourcedate','sourcedatx','sourceref','sstate','stcntyfips','stfips','stname','struct',
# 'structno','structyear','subdivisio','subowntype','subsurfown','sunit','szip','transfdate','layer','path','geometry','Parcel ID 1','Last Name_x',
# 'First Name_x','Mailing #_x','Mailing Address_x','Mailing City_x','Removed_x','Property #_x','Property Address_x','Unit #_x','Subdivsion_x',
# 'Property City_x','Property State_x','Property Zipcode_x','Mailing State_x','Mailing Zipcode_x','Returned_x','Bad Address_x','Section_x',
# 'Zone_x','Mad Children_x','Property Type 1','Parcel ID 2','Last Name_y','First Name_y','Mailing #_y','Mailing Address_y','Mailing City_y',
# 'Removed_y','Property #_y','Property Address_y','Unit #_y','Subdivsion_y','Property City_y','Property State_y','Property Zipcode_y','Mailing State_y',
# 'Mailing Zipcode_y','Returned_y','Bad Address_y','Section_y','Zone_y','Mad Children_y','Property Type 2','Parcel ID Stripped_x',
# 'Parcel ID 3','Last Name_x','First Name_x','Mailing #_x','Mailing Address_x','Mailing City_x','Removed_x','Property #_x','Property Address_x','Unit #_x',
# 'Subdivsion_x','Property City_x','Property State_x','Property Zipcode_x','Mailing State_x','Mailing Zipcode_x','Returned_x','Bad Address_x',
# 'Section_x','Zone_x','Mad Children_x','Property Type 3','Parcel ID Stripped_y','Parcel ID Shortened_x','Parcel ID 15','Parcel ID 4','Last Name_y',
# 'First Name_y','Mailing #_y','Mailing Address_y','Mailing City_y','Removed_y','Property #_y','Property Address_y','Unit #_y','Subdivsion_y',
# 'Property City_y','Property State_y','Property Zipcode_y','Mailing State_y','Mailing Zipcode_y','Returned_y','Bad Address_y','Section_y',
# 'Zone_y','Mad Children_y','Property Type 4','Parcel ID Stripped','Parcel ID Shortened_y']
#
#
##add them together
